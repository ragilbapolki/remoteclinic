...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="fotoer-buttons _medicines-buttons">
            ...
            <?php if(display_permission("medicine_directory")==true){?><a href="https://app.cobradental.co.id:1780/sales-dev" target="_blank"><li class="inl-pending">Order Stock</li></a><?php }?>
            <?php if(display_permission("medicine_directory")==true){?><a href="https://cobradental.co.id" target="_blank"><li class="inl-branches">Promo Website</li></a><?php }?>
        </div>
