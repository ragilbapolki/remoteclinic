						...
						?>
							...
							<form method="POST" action="" enctype="multipart/form-data">
								...
								<div class="form-group"><label>Title:</label><select class="form-control" name='title' id='title' size='1' tabindex='1'>
										<option value='<?php echo "$profile->title"; ?>'><?php echo "$profile->title"; ?>
											(Current)</option>
								...
								<div class="form-group"><label>Mobile Number:</label><input class="form-control" name="mobile" type="text" value="<?php echo "$profile->contact"; ?>" /><i>Hidden
										from
										the staff with access level less than 4</i></div>
								...
								<div class="form-group"><label>Personal Address:</label><input class="form-control" name="address" type="text" value="<?php echo "$profile->address"; ?>" /><i>Hidden
								...
								<div class="form-group"><label>Access Level:</label><select class="form-control" name='access_level' id='access_level' size='1' tabindex='1'>
										<option value='<?php echo "$profile->access_level"; ?>'>
											<?php echo "$profile->access_level"; ?> (Current)</option>
								...
								<div class="form-group"><label>Status:</label><select class="form-control" name='status' id='status' size='1' tabindex='1'>
										<option value='<?php echo "$profile->status"; ?>'><?php echo "$profile->status"; ?>
											(Current)</option>
								...
								<div class="form-group"><label>Branch:</label>
									<select class="form-control" name='branch' id='branch' size='1' tabindex='1'>
										<option value='<?php echo "$profile->branch"; ?>'>
											<?php echo "$global_permission->guardian_short_name"; ?><?php echo "$profile->branch"; ?>
											(Current)</option>
										<?php
