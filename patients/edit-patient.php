					...
					<div class="card-body">
						...
						<form method="post" action="" enctype="multipart/form-data">
							...
							<div class="form-group"><label>Gender:</label><select class="form-control" name='gender' id='gender' size='1'>
									<option value='<?php echo patient_info("gender", $id); ?>'>
										<?php echo patient_info("gender", $id); ?> (Current)</option>
									<option value='Male'>Male</option>
									<option value='Female'>Female</option>
									<option value='Other'>Other</option>
								</select></div>
							<div class="form-group"><label>Age:</label><select class="form-control" name='age' id='age' size='1'>
									<option value="<?php echo patient_info("age", $id); ?>">
										<?php echo patient_info("age", $id); ?> (Current)</option>
							...
							<div class="form-group"><label>Serial:</label><select class="form-control" name='serial' class="inputOne" id='serial' size='1'>
									<option value="<?php echo patient_info("serial", $id); ?>">
										<?php echo patient_info("serial", $id); ?> (Current)</option>
							...
							<div class="form-group"><label>Contact Number:</label><input class="form-control" name="contact" type="text" value="<?php echo patient_info("contact", $id); ?>" />
							</div>
							<hr>
