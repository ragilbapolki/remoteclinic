                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        if (isset($_POST['submit'])) {
                            ...
                            $result = prescribe($report_id, $medicine, $doses, $days,  $medicine_charge, $price_set);
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group fieldGroup">
                                <div class="input-group">
                                    ...
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="doses" name="doses" size='1' tabindex='1' placeholder="Jumlah Obat" onkeyup="sum();" />
                                    </div>
                                    <div class="col-2">
                                        <input type="text" class="form-control" id="price_set" name="price_set" size='1' tabindex='1' placeholder="Harga" onkeyup="sum();" />
                                    </div> =
                                    <div class="col-2">
                            ...
                            <input type="hidden" id="medicine_charge" name="medicine_charge" value="yes" class="inputOne" cols="9" rows="4" />
                            ...
                            <div class="panel-body">
                                <table class="table table-striped link-patients link-patients">
                                    <tbody>
                                        <tr>
                                            <td>Patient:</td>
                                            <td><a href="../patients/profile.php?id=<?php echo patient_info("id", $patient_id); ?>" class="patient"><?php echo patient_info("name", $patient_id); ?></a>
                                                |
                                        ...
                                        <tr>
                                            <td>Registered By:</td>
                                            <td><a class="staff" href="../staff/profile.php?id=<?php echo patient_info("physician", $patient_id); ?>"><?php echo staff_info("full_name", patient_info("physician", $patient_id)); ?></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Last Update:</td>
