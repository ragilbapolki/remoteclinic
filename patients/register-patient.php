                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="" enctype="multipart/form-data">
                            <div class="form-group"><label>Jenis Kelamin:</label><select name='gender'
                                    class="form-control" id='gender' size='1'>
                                    <option value='Male'>Laki-Laki</option>
                                    <option value='Female'>Perempuan</option>
                                    <option value='Other'>Other</option>
                                </select></div>
                            <div class="form-group"><label>Umur :</label><select class="form-control" name='age'
                                    id='age' size='1'>
                            ...
                            <div class="form-group"><label>Serial:</label><select class="form-control" name='serial'
                                    class="inputOne" id='serial' size='1'>
                                ...
                                <div class="form-group"><label>Nama Lengkap:</label><input class="form-control"
                                        name="name" type="text" placeholder="John Doe" /></div>
                                <div class="form-group"><label>No. Telp/WA :</label><input class="form-control"
                                ...
                                <div class="form-group"><label>Email:</label><input class="form-control" name="email" type="text" />
                                </div>
